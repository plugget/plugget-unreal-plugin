...
def add_cmd_to_menu(label=None, command=None, tooltip=None, icon=None):
    ...
    parent_menu = unreal_menus.find_menu("LevelEditor.MainMenu.Edit")
...
def project_site_dir():
    ...
    return Path(
        content_path) / r"Python\Lib\site-packages"  # 'C:/Users/USER/MyProject/Content/Python/Lib/site-packages'
...
if os.getenv("PLUGGET_UE_MENU", "1") == "1":
    add_cmd_to_menu(label="Plugget Packages",
                    command="import plugget_qt;plugget_widget = plugget_qt.show()",
                    tooltip="open the Plugget UI Qt Window")


print("Finished setup unreal-qt plugin")
